 ...
 */
public class OffsetInstanceEditorPanel extends javax.swing.JPanel {
...
//<editor-fold defaultstate="collapsed" desc="Properties">
     ...
     */
    public void setOffsetListProvider(OffsetListProviderIntf offsetListProvider) {
...
//<editor-fold defaultstate="collapsed" desc="Data Update Methods">
    ...
    public void updateOffsetListDisplay() {
        ...
        if (offsetListProvider != null) {
            offsetListProvider.getOffsetIDsSorted().stream().forEachOrdered(offsetID -> jcbxOriginalOffset.addItem(offsetID));
        }
...
//            this.s(offset.getOffsetID());
    ...
    public void updateOffsetData() {
        if (offset != null) {
            offset.setOffsetID(jtxtBaseName.getText());
...
//</editor-fold>
     ...
     */
    public OffsetInstanceEditorPanel(Offset offset) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jpnlOriginalOffsetLayout.setHorizontalGroup(
            ...
            .addGroup(jpnlOriginalOffsetLayout.createSequentialGroup()
                ...
                .addComponent(jcbxOriginalOffset, 0, 253, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
